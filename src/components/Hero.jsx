...
const Hero = () => {
  return (
    <div className="flex flex-col p-8 h-screen">
      ...
      <div  className="text-xl md:text-2xl lg:text-3xl flex-col text-neutral-50 z-1 absolute text-left max-w-2/3 xl:max-w-1/3 opacity-100 font-basker-regular -mt-2">
        <h1 className="mb-4">
