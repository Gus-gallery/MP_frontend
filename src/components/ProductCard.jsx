...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="flex flex-col gap-2 mb-2 p-2 max-w-1/2 md:max-w-1/3 lg:max-w-1/4">
      <img className="border border-zinc-100 object-cover aspect-square w-full" src={product.image} alt={product.name} />
